...
public class GuestBookingFactory extends Factory{
	...
	public void Payment(String gender,String firstname,String lastname,String date,String month,String year,String mobileno,String cardnumber,String expirymonth,String expiryyear,String cardName,String cvv) throws Exception
	{
		...
		new WebDriverWait(driver, 7).until(ExpectedConditions.visibilityOf(Element.getElementProp("p_dropDown")));
		new Select(Element.getElementProp("p_dropDown")).selectByValue(gender);
		...
		new Select(Element.getElementProp("p_bday")).selectByValue(date);
		//Element.getElementProp("p_bday").sendKeys(date);
		new Select(Element.getElementProp("p_bmonth")).selectByValue(month);
		//Element.getElementProp("p_bmonth").sendKeys(month);
		new Select(Element.getElementProp("p_byear")).selectByValue(year);
		//Element.getElementProp("p_byear").sendKeys(year);
		Element.getElementProp("p_MobNum").clear();
		...
		Element.getElementProp("p_creditCardNumber").sendKeys(cardnumber);
	/*	Element.getElementProp("p_expiryMonth").sendKeys(number);
		Element.getElementProp("p_expiryYear").sendKeys(number);*/
		
		new Select(Element.getElementProp("p_expiryMonth")).selectByValue(expirymonth);
		//Element.getElementProp("p_expiryMonth").sendKeys(expirymonth);
		//new Select(Element.getElementProp("p_expiryYear")).selectByValue(expiryyear);
		Element.getElementProp("p_expiryYear").sendKeys(expiryyear);
		Element.getElementProp("p_cardName").sendKeys(cardName);
		Element.getElementProp("p_cvv").sendKeys(cvv);
		Element.getElementProp("p_singlepayment").click();
		//Element.getElementProp("p_termsClick").click();
		Element.getElementProp("p_payment").click();
	}
