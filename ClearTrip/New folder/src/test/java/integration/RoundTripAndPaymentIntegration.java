...
public class RoundTripAndPaymentIntegration extends Base {
	...
	public void roundTripSearch(String source,String destination,String depDate,String retDate,String adults, String children,String infants) throws Exception 
	{
