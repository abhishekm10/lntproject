	 ...
	 * public MultiCity(WebDriver webDriverObj)
		...
		public void checkStops()
		{
			...
			try {
				...
				Element.getElementProp("zeroStops").click();
			Thread.sleep(1000);
			Element.getElementProp("oneStops").click();
			Thread.sleep(1000);
			Element.getElementProp("twoStops").click();
			Thread.sleep(1000);
			Element.getElementProp("threeStops").click();
			Thread.sleep(1000);
		...
		/*	By  EarlyMorning = By.xpath("//*[contains(text(),'Early Morning')]");
			...
			System.out.println(Element.getElementProp("earlyMorning"));
			...
			Thread.sleep(1000);
			Element.getElementProp("evening").click();
			Thread.sleep(1000);
			Element.getElementProp("night").click();
			Thread.sleep(1000);
			Element.getElementProp("night").click();
			Thread.sleep(1000);
			Element.getElementProp("evening").click();
